...
In order to support loading of multiple wallets in oyster-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is oyster.cpp.
...
Changes to oyster.cpp
----------------------
oyster.cpp is the entry point into oyster-qt, and as such, will require some minor modifications to provide hooks for

...
The oyster project operates an open contributor model where anyone is
...
The following applies to code changes to the oyster project, and is not to be
confused with overall oyster Network Protocol consensus changes.

Whether a pull request is merged into oyster rests with the project merge
...
Patches that change oyster consensus rules are considerably more involved than
...
Where a patch set proposes to change the oyster consensus, it must have been
...
The project leader is the release manager for each oyster release.

...
RESOURCES += src/qt/oyster.qrc src/qt/oyster_locale.qrc

TRANSLATIONS += src/qt/locale/oyster_bg.ts \
                src/qt/locale/oyster_de.ts \
                src/qt/locale/oyster_en.ts \
                src/qt/locale/oyster_es.ts \
                src/qt/locale/oyster_fi.ts \
                src/qt/locale/oyster_fr.ts \
                src/qt/locale/oyster_it.ts \
                src/qt/locale/oyster_ja.ts \
                src/qt/locale/oyster_pl.ts \
                src/qt/locale/oyster_pt.ts \
                src/qt/locale/oyster_ru.ts \
                src/qt/locale/oyster_sk.ts \
                src/qt/locale/oyster_sv.ts \
                src/qt/locale/oyster_vi.ts \
                src/qt/locale/oyster_zh_CN.ts \
                src/qt/locale/oyster_zh_TW.ts

...
This means one can have an always-on oysterd instance running, and another local oysterd/oyster-qt instance which connects to this node and receives blocks from it.

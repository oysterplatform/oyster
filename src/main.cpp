...
#if defined(NDEBUG)
#error "oyster cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight < 2 && nHeight > 0) {
      ...
      nSubsidy = 50 * COIN;
    } else if (nHeight >= 1001 && nHeight < 11000) {
      nSubsidy = 14 * COIN;
    } else if (nHeight >= 11000 && nHeight < 50000) {
      nSubsidy = 18 * COIN;

...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000035440bf8b4963b89719c8b6da2a263fe14e08ebad24452e5e8bd13a4eee"));
...
public:
	...
	nMasternodeColleteralLimxDev = 5000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "Master nodes from europe - 18/Jan/2018.";
        ...
        vSeeds.push_back(CDNSSeedData("oyster1", "207.148.121.156"));
        vSeeds.push_back(CDNSSeedData("oyster2", "199.247.11.25"));

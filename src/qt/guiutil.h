...
/** Utility functions used by the oyster Qt UI.
 */
namespace GUIUtil
{
...
// Render oyster addresses in monospace font
...
// Parse "oyster:" URI into recipient object, return true on successful parsing

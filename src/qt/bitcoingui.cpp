...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a oyster address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and oyster: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About oyster"), this);
    aboutAction->setStatusTip(tr("Show information about oyster"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for oyster"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your oyster addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified oyster addresses"));
    ...
    openAction->setStatusTip(tr("Open a oyster: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the oyster help message to get a list with possible oyster command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("oyster client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to oyster network", "", count));
}
...
{
    QString strTitle = tr("oyster"); // default title

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("oyster oyster-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  oyster-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded oyster transaction") + "\n" +
                               "  oyster-tx [options] -create [commands]   " + _("Create hex-encoded oyster transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded oyster transaction

...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* oyster features */
        {"oyster", "masternode", &masternode, true, true, false},
        {"oyster", "listmasternodes", &listmasternodes, true, true, false},
        {"oyster", "getmasternodecount", &getmasternodecount, true, true, false},
        {"oyster", "masternodeconnect", &masternodeconnect, true, true, false},
        {"oyster", "masternodecurrent", &masternodecurrent, true, true, false},
        {"oyster", "masternodedebug", &masternodedebug, true, true, false},
        {"oyster", "startmasternode", &startmasternode, true, true, false},
        {"oyster", "createmasternodekey", &createmasternodekey, true, true, false},
        {"oyster", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"oyster", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"oyster", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"oyster", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"oyster", "getmasternodescores", &getmasternodescores, true, true, false},
        {"oyster", "mnbudget", &mnbudget, true, true, false},
        {"oyster", "preparebudget", &preparebudget, true, true, false},
        {"oyster", "submitbudget", &submitbudget, true, true, false},
        {"oyster", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"oyster", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"oyster", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"oyster", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"oyster", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"oyster", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"oyster", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"oyster", "checkbudgets", &checkbudgets, true, true, false},
        {"oyster", "mnsync", &mnsync, true, true, false},
        {"oyster", "spork", &spork, true, true, false},
        {"oyster", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"oyster", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use oysterd, or the -server option to oyster-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> oyster-cli " + methodname + " " + args + "\n";
}

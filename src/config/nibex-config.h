/* src/config/oyster-config.h.  Generated from oyster-config.h.in by configure.  */
/* src/config/oyster-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef oyster_CONFIG_H

#define oyster_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.oyster.co"

/* Define to the full name of this package. */
#define PACKAGE_NAME "oyster Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "oyster Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "oyster"
